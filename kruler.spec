...
Version  : 19.12.1
Release  : 16
URL      : https://download.kde.org/stable/release-service/19.12.1/src/kruler-19.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.1/src/kruler-19.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.1/src/kruler-19.12.1.tar.xz.sig
...
%prep
%setup -q -n kruler-19.12.1
cd %{_builddir}/kruler-19.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578680164
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kruler-19.12.1/COPYING %{buildroot}/usr/share/package-licenses/kruler/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/kruler-19.12.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/kruler/1bd373e4851a93027ba70064bd7dbdc6827147e1
pushd clr-build
%make_install
popd
%find_lang kruler
