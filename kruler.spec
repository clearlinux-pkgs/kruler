...
Version  : 24.12.2
Release  : 79
URL      : https://download.kde.org/stable/release-service/24.12.2/src/kruler-24.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/kruler-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/kruler-24.12.2.tar.xz.sig
...
%setup -q -n kruler-24.12.2
cd %{_builddir}/kruler-24.12.2
pushd ..
cp -a kruler-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738956948
mkdir -p clr-build
pushd clr-build
