...
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/kruler-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/kruler-24.12.0.tar.xz.sig
...
%setup -q -n kruler-24.12.0
cd %{_builddir}/kruler-24.12.0
pushd ..
cp -a kruler-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735188942
mkdir -p clr-build
pushd clr-build
...
/usr/share/doc/HTML/sl/kruler/index.cache.bz2
/usr/share/doc/HTML/sl/kruler/index.docbook
