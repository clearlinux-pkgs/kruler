...
Source0  : https://download.kde.org/stable/release-service/20.08.3/src/kruler-20.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.3/src/kruler-20.08.3.tar.xz.sig
...
%prep
%setup -q -n kruler-20.08.3
cd %{_builddir}/kruler-20.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604598452
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kruler-20.08.3/COPYING %{buildroot}/usr/share/package-licenses/kruler/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/kruler-20.08.3/COPYING.DOC %{buildroot}/usr/share/package-licenses/kruler/1bd373e4851a93027ba70064bd7dbdc6827147e1
pushd clr-build
%make_install
popd
%find_lang kruler
